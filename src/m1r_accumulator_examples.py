...
#
#              for k in range(r - s): range can't be negative
#                  count = 0
#                  if math.cos(r) > 0:
#                      count = 1
#                  return count       can't return in a loop
#
...
#        and one is WRONG.  Which is the WRONG one? the second one
#
#              x = starting_point.x
#              for k in range(n):
